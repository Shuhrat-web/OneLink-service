...
- `admin`: видит все ссылки, может создавать/редактировать/удалять любые ссылки, смотреть stats/events по всем ссылкам, а dashboard-метрики/графики — глобально по всей системе.
- `user`: видит только свои ссылки, может создавать ссылки, редактировать/удалять только свои, смотреть stats/events только по своим, а dashboard-метрики/графики — только по своим ссылкам (owner-scoped).
